...
app.use((req, res, next) => {
    res.locals.user = req.session.user || null; // Store user in `res.locals`
    next();
});
...
//             }
//             res.render("users.ejs", { users: results, classes: classResults });
//         });
...
// app.get("/admin/add-user", authMiddleware("admin"), (req, res) => {
//     let q = "SELECT class_id, class_name FROM classes ORDER BY class_id";
//     connection.query(q, (err, classResults) => {
//         if (err) {
//             console.error(err);
...
//         res.render("add-user.ejs", { classes: classResults });
//     });
// });

app.post("/admin/add-user", authMiddleware("admin"), async (req, res) => {
...
// app.get("/admin/edit-user/:id", authMiddleware("admin"), (req, res) => {
...
//     connection.query(q1, [userId], (err, result) => {
//         if (err) {
...
//         }
//         let q2 = "SELECT class_id, class_name FROM classes ORDER BY class_id";
//         connection.query(q2, (err, classResults) => {
//             if (err) {
//                 console.error(err);
//                 return res.send("Error fetching subjects");
//             }
//             let class_id = result[0].class_id;
//             let q3 = `SELECT class_name FROM classes WHERE class_id = ${class_id}`;
//             connection.query(q3, (err, className) => {
//                 if (err) {
//                     console.error(err);
//                     return res.send("Error fetching subjects");
//                 }
//                 console.log(className);
//                 res.render("edit-user.ejs", { user: result[0], classes: classResults, classInfo: className[0] });
//             });
//         });
//     });
// });

app.post("/admin/edit-user/:id", authMiddleware("admin"), (req, res) => {
    const userId = req.params.id;
...
app.delete("/admin/delete-user/:id", authMiddleware("admin"), (req, res) => {
...
app.get("/class", authMiddleware("admin"), (req, res) => {
    ...
    connection.query(q1, (err, countResult) => {
        ...
        connection.query(q2, (err, classesResult) => {
            ...
            res.render("class.ejs", { count, classes: classesResult });
        });
    });
});

// app.get('/class/new', authMiddleware("admin"), (req, res)=>{
//     res.render("class_new.ejs");
// });

app.post('/class/new', authMiddleware("admin"), (req,res)=>{
...
// app.get("/class/:class_id/edit", authMiddleware("admin"), (req, res)=>{
//     let {class_id} = req.params;
//     let q = `SELECT * FROM classes WHERE class_id='${class_id}'`;
//     try{
//         connection.query(q, (err, classResult)=>{
//             if(err) throw(err);
//             res.render("class_edit.ejs", {class_info: classResult[0]});
//         });
//     }catch{
//         console.log(err);
//         res.send("Some error in database");
...
app.patch("/class/:class_id", authMiddleware("admin"), (req, res)=>{
    let {class_id} = req.params;
...
app.delete("/class/:class_id/delete", authMiddleware("admin"), (req, res)=>{
    let {class_id} = req.params;
...
app.get("/room", authMiddleware("admin"), (req, res) => {
    ...
    connection.query(q1, (err, countResult) => {
        ...
        connection.query(q2, (err, roomsResult) => {
            ...
            res.render("room.ejs", { count, rooms: roomsResult });
        });
    });
});

// app.get('/room/new', authMiddleware("admin"), (req, res)=>{
//     res.render("room_new.ejs");
// });

app.post('/room/new', authMiddleware("admin"), (req,res)=>{
...
// app.get("/room/:room_id/edit", authMiddleware("admin"), (req, res)=>{
//     let {room_id} = req.params;
//     let q = `SELECT * FROM rooms WHERE room_id='${room_id}'`;
//     try{
//         connection.query(q, (err, roomResult)=>{
//             if(err) throw(err);
//             res.render("room_edit.ejs", {room_info: roomResult[0]});
//         });
//     }catch{
//         console.log(err);
//         res.send("Some error in database");
...
app.patch("/room/:room_id", authMiddleware("admin"), (req, res)=>{
    let {room_id} = req.params;
...
app.delete("/room/:room_id/delete", authMiddleware("admin"), (req, res)=>{
    let {room_id} = req.params;
...
app.get("/subject", authMiddleware("admin"), (req, res) => {
    ...
    connection.query(q1, (err, countResult) => {
        ...
        connection.query(q2, (err, subjectsResult) => {
            ...
            connection.query(q3, (err, results) => {
                ...
                res.render("subject.ejs", { count, subjects: subjectsResult,classes: results });
            });
        });
    });
});

// app.get('/subject/new', authMiddleware("admin"), (req, res)=>{
//     let q = "SELECT class_id, class_name FROM classes ORDER BY class_id";
...
//             return res.send("Error fetching subjects");
//         }
//         res.render("sub_new.ejs", { classes: results });
//     });
// });

app.post('/subject/new', authMiddleware("admin"), (req,res)=>{
...
// app.get("/subject/:subject_id/edit", authMiddleware("admin"), (req, res)=>{
//     let {subject_id} = req.params;
//     let q1 = `SELECT * FROM subjects WHERE subject_id='${subject_id}'`;
//     let q2 = `SELECT class_id, class_name FROM classes ORDER BY class_id`;
//     try{
//         connection.query(q1, (err, subjectResult)=>{
//             if(err) throw(err);
//             let class_id = subjectResult[0].class_id;
//             let q3 = `SELECT class_id, class_name FROM classes WHERE class_id='${class_id}'`;
//             connection.query(q2, (err, classesResults) => {
//                 if(err) throw(err);
//                 connection.query(q3, (err, class_result) => {
//                     if(err) throw(err);
//                     res.render("subject_edit.ejs", {subject_info: subjectResult[0], classes: classesResults, class_info: class_result[0]});
//                 });
//             });
//         });
//     }catch{
...
app.patch("/subject/:subject_id", authMiddleware("admin"), (req, res)=>{
    let {subject_id} = req.params;
...
app.delete("/subject/:subject_id/delete", authMiddleware("admin"), (req, res)=>{
    let {subject_id} = req.params;
...
app.get("/teacher", authMiddleware("admin"), (req, res) => {
        ...
        connection.query(q2, (err, teachersResult) => {
            ...
            connection.query(q3, (err, subjectResults) => {
                ...
                connection.query(q4, (err, teacherRes) => {
                    ...
                    res.render("teacher.ejs", { count, teachers: teachersResult, subjects: subjectResults, teacherInfo: teacherRes });
                });
...
// app.get('/teacher/new', authMiddleware("admin"), (req, res) => {
//     let q1 = "SELECT subject_id, subject_name, class_id FROM subjects ORDER BY subject_id";
//     connection.query(q1, (err, subjectResults) => {
//         if (err) {
//             console.error(err);
//             return res.send("Error fetching subjects");
//         }
//         let q2 = "SELECT teacher_name FROM teachers";
//         connection.query(q2, (err, teacherResults) => {
//             if (err) {
//                 console.error(err);
//                 return res.send("Error fetching teachers");
//             }
//             res.render("teach_new.ejs", { subjects: subjectResults, teachers: teacherResults });
//         });
//     });
// });
...
app.post('/teacher/new', authMiddleware("admin"), (req, res) => {
...
// app.get("/teacher/:teacher_id/edit", authMiddleware("admin"), (req, res)=>{
//     let {teacher_id} = req.params;
//     let q = `SELECT * FROM teachers WHERE teacher_id='${teacher_id}'`;
//     try{
//         connection.query(q, (err, teacherResult)=>{
//             if(err) throw(err);
//             res.render("teacher_edit.ejs", {teacher_info: teacherResult[0]});
//         });
//     }catch{
//         console.log(err);
//         res.send("Some error in database");
...
app.patch("/teacher/:teacher_id", authMiddleware("admin"), (req, res)=>{
    let {teacher_id} = req.params;
...
app.delete("/teacher/:teacher_id/delete", authMiddleware("admin"), (req, res) => {
    let { teacher_id } = req.params;
...
app.get("/timing", authMiddleware("admin"), (req, res)=>{
    res.render("timing.ejs", {periodTimings});
});

app.post("/timing", authMiddleware("admin"), (req, res)=>{
...
app.get("/timetable", authMiddleware("admin"), (req, res)=>{
...
app.get("/timetable/view", authMiddleware("admin"), (req, res) => {
    const query = `
    ...
    connection.query(query, (err, results) => {
        ...
        // Render the EJS file and pass the grouped timetable data
        res.render("view_timetable", { timetableByClass, periodTimings});
    });
});

app.post("/timetable/save", authMiddleware("admin"), (req, res) => {
...
app.get("/timetable/saved", authMiddleware("admin"), (req, res) => {
...
app.post("/timetable/update", authMiddleware("admin"), (req, res) => {
    ...
    connection.query(querySelect, [timetableId], (err, results) => {
        ...
        // Merge the updated timetable into the existing timetable
        // for (const period in formattedTimetable) {
        //     if (formattedTimetable[period]) {
        //         if (!timetableData.timetable[period]) {
        //             timetableData.timetable[period] = {};
        //         }
        //         for (const day in formattedTimetable[period]) {
        //             const { room_name, subject_name, teacher_name } = formattedTimetable[period][day];
        //             // Only update if at least one field has a non-empty value
        //             if (room_name || subject_name || teacher_name) {
        //                 timetableData.timetable[period][day] = formattedTimetable[period][day];
        //             }
        //         }
        //     }
        // }
...
// app.delete("/timetable/:timetableId/delete", authMiddleware("admin"), (req, res)=>{
//     let {timetableId} = req.params;
//     //console.log(timetableId);
//     let q = `DELETE FROM saved_timetables WHERE id = ${timetableId}`;
//     connection.query(q, (err, results)=>{
//         if(err){
...
app.delete("/timetable/delete/:created_at", authMiddleware("admin"), async (req, res) => {
    try {
...
async function fetchSavedTimetable() {
    return new Promise((resolve, reject) => {
        ...
        connection.query(q, (err, results) => {
            ...
            // if (results.length === 0) {
            //     console.warn(" No saved timetables found in the database.");
            // } else {
            //     console.log(" Retrieved saved timetables:", results);
            // }
...
//                 const className = timetableObject.class_name || "Unknown Class"; // Extract class name
//                 const timetableData = timetableObject.timetable || {}; // Extract actual timetable
...
//         //console.log("Processed Timetable Data:", classTimetables);
//         res.render("student-timetable.ejs", { classTimetables, periodTimings });
//     });
// });
...
app.get("/student-timetable", authMiddleware("student"), (req, res) => {
    ...
    connection.query(q, [studentClassId], (err, results) => {
        ...
        if (results.length === 0) {
            return res.render("student-timetable.ejs", { classTimetables: [], periodTimings });
        }
...
app.get("/timetable-saved", (req, res)=>{
    //console.log(timetableId);
    let q = `SELECT timetable FROM saved_timetables`;
    connection.query(q, (err, results)=>{
        if(err){
            console.error("Saved Timetable Error");
        }
        res.send(results);
    });
});
